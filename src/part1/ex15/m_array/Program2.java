...
public class Program2{
	public static void main(String[] args) {
		...
		case 1:
			 ...
			 * 
			 * if(kor1<0 || 100<kor1) System.out.println("성적범위(0~100)를 벗어났습니다.");
			 * }while(kor1<0 || 100<kor1);
			 * 
			 * do { System.out.print("국어2:"); kor2 = scan.nextInt();
			 * 
			 * if(kor2<0 || 100<kor2) System.out.println("성적범위(0~100)를 벗어났습니다.");
			 * 
			 ...
			 * 
			 * if(kor3<0 || 100<kor3) System.out.println("성적범위(0~100)를 벗어났습니다.");
			 * 
